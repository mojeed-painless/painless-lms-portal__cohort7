    ...
    <section className="course-content transition-content">
      <div className="transition-card">
        ...
        <div className="transition-text">
          ...
          <p>
            You’ve built the structure and styled the look. Now it’s time to bring your website to
            life. JavaScript is where your pages start to think, react, and respond.
          </p>
        </div>
      </div>

      <PrevNextBtn prevPath="/css_portfolio" nextPath="/js-intro" />
    </section>
  );
}
