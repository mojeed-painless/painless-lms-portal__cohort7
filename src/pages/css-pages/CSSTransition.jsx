    ...
    <section className="course-content transition-content">
      <div className="transition-card">
        ...
        <div className="transition-text">
          ...
          <p>
            You’ve built the web's skeleton with HTML. Now, it’s time to add skin, color, and
            personality! We're diving into the world of beautiful design and layout.
          </p>
        </div>
      </div>

      <PrevNextBtn prevPath="/html-style" nextPath="/css_introduction" />
    </section>
  );
}
