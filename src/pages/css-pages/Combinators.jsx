    ...
    <section className="course-content">
      ...
      <section>
        <div className="course-content__container">
          <p>
            In CSS, combinators define relationships between selectors, allowing you to target
            elements based on their position or relationship in the CSS structure. This is essential
            for building efficient and organized CSS rules.
          </p>
          ...
          <p>
            Selects all elements that are descendants (children, grandchildren, etc.) of a specified
            element.
          </p>
...
<div class="parent">
   ...
   <div>
    ...
    color: green;
          ...
          <p>
            <strong>Explanation:</strong> All <code className="code">&lt;p&gt;</code> elements
            inside
...
<div class="parent">
   ...
   <p>This is another direct child paragraph.</p>
    ...
    color: red;
          ...
          <p>
            <strong>Explanation:</strong> Only the first and third &lt;p&gt; (direct children of
          ...
          <p>
            Selects the element that is immediately after a specified element and has the same
            parent.
          </p>
...
<div>
   ...
   <p>This paragraph is not affected.</p>
    ...
    color: blue;
          ...
          <p>
            <strong>Explanation:</strong> Only the first &lt;p&gt; after the &lt;h3&gt; will be
            blue. The second &lt;p&gt; won't be affected.
          </p>

          <h3>General Sibling Selector (~)</h3>
          <p>Selects all siblings of an element that come after it and share the same parent.</p>
...
<div>
   ...
   <span>Span after heading</span>
    ...
    color: purple;
          ...
          <p>
            <strong>Explanation:</strong> Both &lt;p&gt; tags after &lt;h4&gt; will be purple
            because they are siblings of the &lt;h4&gt;.
          </p>
          ...
          <VideoBox title="Combinators" code="Xmc10gmGz_4" />
        </div>
      </section>

      <QuizBox currentCategory="css2" currentTopic="Combinators" />
      <PrevNextBtn prevPath="/css_grid" nextPath="/css_pseudoclass" />
    </section>
  );
}
