    ...
    <section className="course-content">
      ...
      <section>
        <div className="course-content__container">
          ...
          <p>
            By choosing to be part of this rigorous yet rewarding learning experience, you’ve taken
            a bold step toward preparing yourself for real-world success in the tech industry.
          </p>

          <p>
            Let’s begin with this introductory section — it’s packed with essential onboarding
            details and a clear overview of what’s ahead.
          </p>
          ...
          <p>
            It’s often said that you don’t truly understand something until you can teach it to
            someone else. But I believe the real test of understanding is being able to teach it to
            a computer.
          </p>
          ...
          <p>
            Well, keep in mind—your computer doesn’t speak your native language. It doesn’t
            understand English, French, or any human language.
          </p>

          <h3 className="bold">
            What the computer understand is <i> the programming languages.</i>
          </h3>

          <p className="definition">
            <i>
              <b>What is Computer Programming?</b>
            </i>
            At its core, computer programming is the process of writing a set of instructions that a
          ...
          <h3 className="bold">
            In essence, programming is the language of creation in the digital world—and you're
            about to learn how to speak it.
          </h3>
        </div>
      </section>
      ...
      <PrevNextBtn prevPath="/welcome" nextPath="/why" />
    </section>
  );
}
