...
export default function WelcomeScreen() {
  ...
  function handleSelect(selectedHead) {
    setIsSelected((prev) => (prev === selectedHead ? '' : selectedHead));
      ...
      <header>
        ...
        <div className="header__text">
          ...
          <p className="line-clamp-8">
            This course is carefully designed to take complete beginners from ground level to
            confident web developers. Whether you’ve never written a line of code before or you're
            curious about how websites are built, this is the perfect starting point. By the end of
            the course, you’ll have a solid foundation in web technologies and the hands-on skills
            to create modern, responsive websites—ready to take on real-world projects or dive
            deeper into advanced development.
          </p>
        </div>
      </header>
          ...
          <div key={topic.id} className="welcome__container">
            <div className="head" onClick={() => handleSelect(topic.section)}>
              <div className="head__left">
                ...
                <p>
                  <span>{topic.section}:</span> {topic.description}
                </p>
              </div>
              ...
              {topic.subjects.map((subject) => {
                ...
                return (
                  <Link
                    key={subject.path}
                    to={subject.path}
                    className={isCompleted ? 'completed-subject' : ''}
                  >
                    <div>
                      {isCompleted ? (
