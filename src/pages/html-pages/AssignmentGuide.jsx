    ...
    <section className="course-content">
      ...
      <section>
        <div className="course-content__container">
          <h3 className="bold">
            Before we proceed, watch this video to learn how to properly submit your assignments
            through the portal
          </h3>
          ...
          <AssignmentBox title="My first project">
            <ol>
              <li>
                Create a file and name it exactly <i>"my_first_project"</i>
              </li>
              ...
              <li>
                <i>"My name is (your name here)"</i>
              </li>
              <li>
                <i>"I can't wait to learn more about Web Development"</i>
              </li>
