...
import { MoveRight, CircleCheckBig, Star } from 'lucide-react';
    ...
    <div className="home__container">
      <nav className="home__navbar">
        ...
        <div className="home__nav-auth">
          ...
          <Link to="/register" className="home__btn">
            Get Started
          </Link>
        </div>
      </nav>
      ...
      <section className="home__hero">
        ...
        <div className="home__hero-content">
          ...
          <h1>
            Master Frontend <br />
            Development <span className="text-gradient">The Modern Way</span>
          </h1>

          <p>
            From HTML basics to React mastery — learn through interactive projects, daily quizzes,
            and code reviews with mentor feedback.
          </p>

          <div className="home__hero-btns">
            <a href="https://wa.me/9124323167" target="_blank" className="contact-us">
              Contact us
            </a>
            <Link to="/register">
              Start Learning
